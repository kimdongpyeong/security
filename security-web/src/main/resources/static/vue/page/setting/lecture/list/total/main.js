var SettingLectureTotalMainPage;
SettingLectureTotalMainPage = Vue.component("setting-lecture-list-total-main-page", async function (resolve) { resolve({
    "template": (await axios.get("/vue/page/setting/lecture/list/total/main.html")).data,
    "data": function () {
        return {
            "data": {
                "classRoomList": [],
