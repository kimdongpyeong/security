...
StudentListDetail = Vue.component("test5-studentListDetail-page", async function(resolve) {
    resolve({
        "template": (await axios.get("/vue/page/testpage/test5/studentList/detail/main.html")).data,
        "data": function() {
            return {
                data: {
                    studentId: null,
