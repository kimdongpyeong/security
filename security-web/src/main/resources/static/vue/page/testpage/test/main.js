var TestPage;
TestPage = Vue.component("test-page", async function(resolve) {
    resolve({
        "template": (await axios.get("/vue/page/testpage/test/main.html")).data,
        "data": function() {
            return {
                "today": "",
                "time": "",
...
//                let url = 'https://supporti.kr/test';
...
//                            mobileWebUrl: 'https://supporti.kr',
                            webUrl: 'http://localhost:9090/test',
                        },
                    },
                });
            },
            "urlCopy": async function(){
...
//				}
            ...
            "setSelectedRoom": async function(id) {
                ...
                //참여코드가 null인경우 공백으로 초기화해주기
                if(this.select.selectedRoom.code === 'null'){
                    this.select.selectedRoom.code = "";
                }
