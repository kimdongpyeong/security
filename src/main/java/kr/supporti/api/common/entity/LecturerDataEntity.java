...
@AllArgsConstructor
@NoArgsConstructor
public class LecturerDataEntity {
    ...
    @Column(name = "`lecturer_id`", columnDefinition = "bigint(20)", nullable = true)
    ...
    @Column(name = "`subtitle`", columnDefinition = "enum('Y','N')", nullable = true)
