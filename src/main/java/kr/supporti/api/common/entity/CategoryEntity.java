...
public class CategoryEntity {
    ...
    @NotNull(groups = { CreateValidationGroup.class, ModifyValidationGroup.class })
    @Column(name = "`desc`", columnDefinition = "varchar(50)", nullable = false)
    private String desc;

    @NotNull
    @Column(name = "`publish_yn`", columnDefinition = "enum('Y','N')", nullable = false)
    private String publishYn;

    @Column(name = "`order_no`", columnDefinition = "int(2)", nullable = true)
