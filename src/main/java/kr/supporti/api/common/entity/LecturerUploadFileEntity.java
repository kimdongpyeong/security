...
@Entity
@Table(name = "`tb_lecturer_student_file_detail`")
...
@AllArgsConstructor
@NoArgsConstructor
public class LecturerUploadFileEntity {
    ...
    @Column(name = "`lecturer_student_file_id`", columnDefinition = "bigint(20)", nullable = true)
    private Long lecturerStudentFileId;
