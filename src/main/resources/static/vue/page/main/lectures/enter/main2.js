    ...
    resolve({
        ...
        "methods": {
            ...
            "loadClassRoomUser": async function(){
                let roomUserList = (await meta.api.common.classRoomUser.getClassRoomUserList({
                        "page": 1,
                        "rowSize": 100000000,
                ...
                console.log(this.data.countRemainder);
                ...
                if(this.data.user.id){
                	...
                	if(this.guestId){
                    	...
                    	if(guestList.find(e => e.id === this.guestId)){
                            this.$router.push({
                                "path": "/main/lectures/chat",
                                "query": {
                                    "id": this.data.classroomId
                    		...
                    		if(this.data.countRemainder > 0){
                    			this.visible.userInfoVisible = true;
                    		} else{
                    			meta.alert("강의실 참여 인원이 모두 차 입장이 불가합니다.");
                                this.$router.replace("/");
                    		}
