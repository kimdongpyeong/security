var MypageLecturerInfoPage;
MypageLecturerInfoPage = Vue.component("mypage-lecturer-info-page", async function (resolve) {
    resolve({
        "template": (await axios.get("/vue/page/mypage/lecturer/main/main-detail.html")).data,
        "data": function () {
            return {
                "data": {
                    "user": {},
