var SettingParentsCourseMainPage;
SettingParentsCourseMainPage = Vue.component("setting-parentsCourse-main-page", async function (resolve) { resolve({
    "template": (await axios.get("/vue/page/setting/course/parentsCourse/main.html")).data,
    "data": function () {
        return {
            "data": {
                "userList": [],
