var SettingLecturerCategoryMainPage;
SettingLecturerCategoryMainPage = Vue.component("setting-lecturerCategory-main-page", async function (resolve) { resolve({
    "template": (await axios.get("/vue/page/setting/lecture/list/lecturerCategory/main.html")).data,
    "data": function () {
        return {
            "data": {
                "userList": [],
