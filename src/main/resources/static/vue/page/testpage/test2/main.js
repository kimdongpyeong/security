var Test2Page;
Test2Page = Vue.component("test2-page", async function(resolve) {
    resolve({
        "template": (await axios.get("/vue/page/testpage/test2/main.html")).data,
        "props": {
            roomId: {
                type: Number,
                default: 0
...
//			                })).data;
//						}
//						await meta.api.common.room.modifyRoom(room.id, room);
//						meta.api.common.roomUser.removeRoomUser({
//							"roomId": room.id,
//							"userId": this.data.user.id,
//						});
//						meta.alert(room.roomName + "에서 나가셨습니다");
//						await this.$router.go();
//					}
//				} else {
//					if (await meta.confirm(room.roomName + "에서 나가시겠습니까?" )) {
