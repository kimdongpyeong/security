var Test3MypageCreatorMainDetail;
Test3MypageCreatorMainDetail = Vue.component("test3-mypage-creator-main-detail-page", async function (resolve) {
    resolve({
        "template": (await axios.get("/vue/page/testpage/test3/mypage/main-detail.html")).data,
        "data": function () {
            return {
                "data": {
                    "user": {},
        ...
        "methods": {
            ...
            "loadUserInfo" : async function() {
                this.data.user = (await meta.api.common.myPage.getUser(this.data.user.id)).data;

                this.data.user.profileSrc = "/api/app/images?subpath=profile&filename=" + this.data.user.saveFileNm;
            },
